...
#    Updated: 2023/08/17 10:28:04 by aessaoud         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=main.c draw_me.c key_me.c checker.c extract_map.c cast.c render_wall.c draw_update_objects.c horizontal_intersection.c vertical_intersection.c utils.c
OBJS_DIR=objs/
