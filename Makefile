...
#    Updated: 2023/08/22 17:58:44 by aessaoud         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=main.c draw_me.c key_me.c init_.c checker.c extract_map.c cast.c render_wall.c draw_update_objects.c horizontal_intersection.c vertical_intersection.c utils.c extract_texture.c settings.c
OBJS_DIR=objs/
