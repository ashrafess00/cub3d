...
#    Updated: 2023/08/23 12:26:57 by aessaoud         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=main.c draw_me.c key_me.c init_.c checker.c checker_2.c extract_map.c cast.c render_wall.c draw_update_objects.c horizontal_intersection.c vertical_intersection.c utils.c extract_texture.c extract_mbp.c extract_mcp.c
OBJS_DIR=objs/
